...
import { Bot, Clock, CheckCircle, AlertCircle, Loader, ClipboardList, FileText } from 'lucide-react';
...
// Icon components
const ClipboardIcon = () => <ClipboardList className="h-8 w-8" />;
const FileTextIcon = () => <FileText className="h-8 w-8" />;

...
> **注意**：显示设置现已集成到统一的系统设置面板中。请参阅 [系统设置功能使用说明](./system_settings_guide.md) 获取完整指南。

## 功能概述

显示设置功能允许用户自定义界面的显示效果，包括字体大小、布局模式、动画效果等。该功能现已整合到系统设置面板中，通过右上角的"系统设置"按钮访问，所有设置会自动保存并在下次访问时恢复。
